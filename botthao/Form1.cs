    ...
    public partial class bot : Form
    {
       ...
       public long chatId; // Mk fix trước 1 cái chat id là tài khuản của mk! -> cái này liên quan đến việc nhúng ở bên app
        ...
        public bot()
        {
            ...
            string token = "6153930817:AAFLfVkdA2RO0hZbs2ZM9AWbY1hYpc3vkX8";
            ...
            botClient.StartReceiving(
                ...
                cancellationToken: cts.Token    // Thằng này là hủy cts.Token 
            ...
            AddLog($"bot_cua_thao: @{me.Result.Username}");
            ...
            async Task HandleUpdateAsync(ITelegramBotClient botClient, Update update, CancellationToken cancellationToken)
            {
                ...
                {
                    reply = "FeedBack Giáo viên: 😍😍 Môn học lập trình Windows thầy Đỗ Duy Cốp hay qua!!!😍😍";
                }
